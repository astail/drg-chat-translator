...
_M.update({
    ...
    "b.display.host": {
        "ja": "出さない（同僚がいるホストなので、全員に流す中継の行で読めます）",
        "en": "not shown (you host with other dwarves around; read the relay line sent to everyone)",
        "ko": "표시하지 않음 (다른 드워프가 있는 호스트이므로, 모두에게 보내는 중계 줄에서 읽을 수 있습니다)",
        "zh": "不显示（你是有其他矮人的主机，请看发给所有人的转发行）",
        "zh-tw": "不顯示（你是有其他矮人的主機，請看發給所有人的轉發行）",
        "ru": "не показывается (вы хост и в лобби есть другие гномы; читайте строку ретрансляции для всех)",
    },
    "b.display.host_overlay": {
        "ja": "出さない（同僚がいるホストなので、オーバーレイと全員に流す中継の行で読めます）",
        "en": "not shown (you host with other dwarves around; read the overlay and the relay line)",
        "ko": "표시하지 않음 (다른 드워프가 있는 호스트이므로, 오버레이와 중계 줄에서 읽을 수 있습니다)",
        "zh": "不显示（你是有其他矮人的主机，请看小窗和转发行）",
        "zh-tw": "不顯示（你是有其他矮人的主機，請看小視窗和轉發行）",
        "ru": "не показывается (вы хост и в лобби есть другие гномы; читайте оверлей и строку ретрансляции)",
    },
    "b.toggle": {
    ...
    "b.in.skipped": {
        "ja": "受信 [%s] %s（用語集で訳さない語）",
        "en": "in [%s] %s (a word the glossary leaves untranslated)",
        "ko": "수신 [%s] %s (용어집에서 번역하지 않는 말)",
        "zh": "接收 [%s] %s（术语表中不翻译的词）",
        "zh-tw": "接收 [%s] %s（術語表中不翻譯的詞）",
        "ru": "входящее [%s] %s (глоссарий оставляет без перевода)",
    },
    "b.relay": {
        "ja": "中継(ホスト) %s",
        "en": "relay (host) %s",
    ...
    "b.out.skipped": {
        "ja": "送信 %s（訳さない: %s）",
        "en": "out %s (not translated: %s)",
        "ko": "송신 %s (번역하지 않음: %s)",
        "zh": "发送 %s（不翻译：%s）",
        "zh-tw": "發送 %s（不翻譯：%s）",
        "ru": "исходящее %s (без перевода: %s)",
    },
    "b.out.skip.empty": {
        "ja": "空の発言",
        "en": "empty message",
    ...
    "b.out.skip.disabled": {
        "ja": "送信の翻訳はオフ（DRGT_OUTGOING_ENABLED）",
        "en": "outgoing translation is off (DRGT_OUTGOING_ENABLED)",
        "ko": "송신 번역이 꺼져 있음 (DRGT_OUTGOING_ENABLED)",
        "zh": "发送翻译已关闭（DRGT_OUTGOING_ENABLED）",
        "zh-tw": "發送翻譯已關閉（DRGT_OUTGOING_ENABLED）",
        "ru": "перевод исходящих выключен (DRGT_OUTGOING_ENABLED)",
    },
    "b.out.skip.short": {
        "ja": "短すぎる（DRGT_OUTGOING_MIN_LENGTH）",
        "en": "too short (DRGT_OUTGOING_MIN_LENGTH)",
        "ko": "너무 짧음 (DRGT_OUTGOING_MIN_LENGTH)",
        "zh": "太短（DRGT_OUTGOING_MIN_LENGTH）",
        "zh-tw": "太短（DRGT_OUTGOING_MIN_LENGTH）",
        "ru": "слишком короткое (DRGT_OUTGOING_MIN_LENGTH)",
    },
    "b.out.skip.long": {
        "ja": "長すぎる（DRGT_OUTGOING_MAX_CHARS）",
        "en": "too long (DRGT_OUTGOING_MAX_CHARS)",
        "ko": "너무 김 (DRGT_OUTGOING_MAX_CHARS)",
        "zh": "太长（DRGT_OUTGOING_MAX_CHARS）",
        "zh-tw": "太長（DRGT_OUTGOING_MAX_CHARS）",
        "ru": "слишком длинное (DRGT_OUTGOING_MAX_CHARS)",
    },
    "b.out.skip.prefix": {
        "ja": "コマンドなどの前置きで始まる（DRGT_OUTGOING_IGNORE_PREFIXES）",
        "en": "starts with a command prefix (DRGT_OUTGOING_IGNORE_PREFIXES)",
        "ko": "명령어 등의 접두사로 시작함 (DRGT_OUTGOING_IGNORE_PREFIXES)",
        "zh": "以命令等前缀开头（DRGT_OUTGOING_IGNORE_PREFIXES）",
        "zh-tw": "以指令等前綴開頭（DRGT_OUTGOING_IGNORE_PREFIXES）",
        "ru": "начинается с префикса команды (DRGT_OUTGOING_IGNORE_PREFIXES)",
    },
    "b.out.skip.language": {
        "ja": "翻訳元の言語（{lang}）で打った発言ではない（DRGT_OUTGOING_SOURCE）",
        "en": "not written in the source language ({lang}) (DRGT_OUTGOING_SOURCE)",
        "ko": "번역 원본 언어({lang})로 쓴 발언이 아님 (DRGT_OUTGOING_SOURCE)",
        "zh": "不是用源语言（{lang}）写的（DRGT_OUTGOING_SOURCE）",
        "zh-tw": "不是用來源語言（{lang}）寫的（DRGT_OUTGOING_SOURCE）",
        "ru": "написано не на исходном языке ({lang}) (DRGT_OUTGOING_SOURCE)",
    },
    "b.in.failed": {
        "ja": "受信翻訳に失敗: %s",
