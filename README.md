...
ホストから呼ぶと全員に**表示されます。そのためホストで他の人がいるときは、受信の訳をチャット欄に出すと
それが全員に見えてしまいます。

| 自分の立場 | 受信の訳を自分が読む場所 | 訳を全員のチャットに流す（中継） |
|---|---|---|
| **他の人の部屋に参加**<br>（クライアント） | チャット欄に出ます | **しません**<br>他人の部屋のチャットを勝手に埋めないため |
| **自分の部屋・ソロ**<br>（ホストだが自分ひとり） | チャット欄に出ます<br>（全員に配信されますが、その「全員」が自分だけなので） | **しません**<br>読む相手がいないため |
| **自分の部屋・他の人がいる**<br>（ホスト） | チャット欄には出しません（全員に見えてしまうため）。<br>中継の行に日本語が含まれるので、それを読みます。<br>中継を切っている場合は `settings.ini` の<br>`DRGT_OVERLAY_ENABLED=true` で小窓に出せます | **します**<br>→ [自分がホストのときの中継](#自分がホストのときの中継) |

**自分の発言の翻訳（送信）は、どの立場でも同じです。**
立場で変わるのは「受信した訳が自分にどう見えるか」と「中継するかどうか」の2つだけです。
...
**ホスト（部屋を立てた側）で、他の人がいるときだけ**は、同僚ドワーフの発言の訳を
...
- **クライアントのときとソロのときは中継しません**
  （[ホストとクライアントで変わること](#ホストとクライアントで変わること)）。ソロでは 4言語ぶん訳しても
  読む相手がいないので、訳は日本語だけ作って自分の画面に出します。
...
: 仕様です。ゲーム側に「自分にだけ見せる」手段がなく、チャット欄に出すと
  訳文が全員に見えてしまうためです（[ホストとクライアントで変わること](#ホストとクライアントで変わること)）。
