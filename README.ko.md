...
*Ghost Ship Games 와 무관한 비공식 팬 프로젝트입니다.*
...
1할 요금이 됩니다(Haiku 4.5 는 프롬프트가 너무 짧아 캐시되지 않습니다).
...
: 사양입니다. 호스트의 채팅창에 내보낸 것은 모두에게 전달되므로, 수신 번역은 중계 줄로
  ...
  나오지 않습니다.
  작은 창의 ✕ 나 Esc 는 창을 숨길 뿐이고 번역은 멈추지 않습니다(다음 번역이 오면 다시
  나옵니다). 작은 창의 입력란에 친 문장은 채팅창에서 쳤을 때처럼 원문과 번역 두 번으로
  보내집니다.
